...
using Framework.Northwind.Core.CrossCuttingConcerns.Caching;
using PostSharp.Aspects;

namespace Framework.Northwind.Core.Aspect.PostSharp.CacheAspects
{
    [Serializable]
    public class CacheAspect : MethodInterceptionAspect
    {
        ...
        override public void OnInvoke(MethodInterceptionArgs args)
        {
